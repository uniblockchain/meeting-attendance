package com.example.meetingattendance;
...
public class MicrosoftSignInActivity extends AppCompatActivity {
    ...
    private static final String TAG = MicrosoftSignInActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callGraphButton = (Button) findViewById(R.id.microsoft_button);
